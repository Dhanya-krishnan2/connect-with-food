...
// we are using react router here for the synchronising all the folder
//redux
import { Provider } from "react-redux";
import store from "./redux/store";
// we are using redux to get rid of the states here, everything here is handled by redux

import { SET_AUTHENTICATED } from "./redux/types";
import { logoutAction, getUserData } from "./redux/actions/authActions";

//axios helps us to make the http client to make get and post from the browser
import axios from "./util/axios";

//jwt-decode used here to use jwt token
import jwtDecode from "jwt-decode";

//material-ui to faster and easier designing
import { ThemeProvider as MuiThemeProvider } from "@material-ui/core/styles";
import createMuiTheme from "@material-ui/core/styles/createMuiTheme";

//theme to design the styles
