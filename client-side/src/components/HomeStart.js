    ...
    <section className={classes.presentation}>
      <div className={classes.introduction}>
        ...
        <Typography variant="body2" className={classes.paragraph}>
          Hey, do you want to enjoy homely food. Are you spending a lot of time in the kitchen and dont worry we are here to help you and stay relaxed and enjoy extra-ordinary taste by connecting to food net 
        </Typography>
